...
connection = mysql.connector.connect(host='localhost', database='FNAFBot', user='jwoleben', password='nerdvana4097') 
...
def reconnect_db():
    ...
    if connection is None or not connection.is_connected():
        connection = mysql.connector.connect(host='localhost', database='AuthorMatonTest', user='jwoleben', password='nerdvana4097')
    return connection
...
client.run('NzcxNTU1NjE0OTY2NDE1Mzcy.X5t1KQ.HNVJHoPeAgokzKPnKrglNJpSEyM')